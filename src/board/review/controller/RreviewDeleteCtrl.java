...
/**
 * Servlet implementation class RreviewDeleteCtrl
 */
@WebServlet("/rreviewdelete")
public class RreviewDeleteCtrl extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RreviewDeleteCtrl() {
        super();
	...
	private void execute(HttpServletRequest request, HttpServletResponse response)
		...
		int result = 0;
		try {
			result = new RreviewService().rreviewDelete(rrno, rno);
