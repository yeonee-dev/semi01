		...
		<form action="<%=request.getContextPath()%>/studyupdate" method="post"
			...
			<div style="margin-bottom: 10px;">
				<input id="subject"
					...
					type="text" placeholder="제목을 입력해 주세요." name="ssubject"
					maxlength="100" value="${study.ssubject }">
			</div>
			<div style="margin-bottom: 10px;">
				<textarea id="editor" name="scontent" maxlength="4000">${study.scontent }</textarea>
			</div>
			<div>
